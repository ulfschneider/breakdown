    ...
    return {
        ...
        calcSettingsValueIndent() {
            ...
            if (settings.fixversion) {
                return 11;
            } else if (settings.fromDate) {
                return 9;
            } else if (settings.project || settings.options || settings.markers || settings.predict) {
                return 8;
        ...
        beautifyRow(token, rowCount) {
            ...
            for (let i = 0; i < token.length; i++) {
                ...
                } else if (BreakdownParse.tokenHasScope(t, 'description.value.bkdn')) {                    
                    row = '\t\t\t// ' + value;
