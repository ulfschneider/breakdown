    ...
    return {
        ...
        makeUploadDataStructure(upload, download) {
            ...
            tokens.forEach((token, rowCount) => {
                ...
                if (BreakdownParse.rowHasScope(token, 'issue.no-parent.jira')) {
                    ...
                    issue = null;
                    let noParent = {};
                    BreakdownUtil.setKey(noParent, BreakdownUtil.NO_PARENT_KEY);
        ...
        pushToJira(upload, download, credentials) {
            ...
            return BreakdownPull.pullFromJira(download, credentials)
                ...
                .then(success => {
                    if (success && BreakdownRank.isRankingDesired(upload.settings)) {
                ...
                .then(success => {
                    if (success && upload.uploadJiraObjects.length ||
