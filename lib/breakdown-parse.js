        ...
        parseStoryKeys() {
            ...
            if (this.isBreakdownGrammar()) {
                ...
                tokens.forEach(token => {
                    if (this.rowHasScope(token, 'issue.story.jira') ||
                        this.rowHasScope(token, 'issue.resolved.story.jira') ||
                        this.rowHasScope(token, 'issue.delete.story.jira')) {
                        storyKeys.push(this.parseKey(token));
                    }
                });
            }
