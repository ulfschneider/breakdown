        ...
        extractCustomFieldNames(fields) {
            ...
            for (let i = 0; i < fields.length &&
                (!settings.epicLinkFieldName ||
                    ...
                    !settings.acceptanceCriteriaFieldName); i++) {
                ...
                if (!settings.acceptanceCriteriaFieldName && fields[i].name == 'Acceptance Criteria') {
                    settings.acceptanceCriteriaFieldName = fields[i].id;
                }
            }
            ...
            if (!settings.acceptanceCriteriaFieldName) {
                console.log('Custom field Acceptance Criteria not extracted');
