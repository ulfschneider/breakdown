...
export default BreakdownUtil = (function () {
    ...
    return {
        ...
        setDescription(issue, description, method) {
        ...
        setAcceptanceCriteria(issue, description, method) {
            let settings = BreakdownEnvironment.getSettings();
            description = this.joinLines(description);
            ...
            if (description && settings.acceptanceCriteriaFieldName) {
                ...
                delete issue.fields[settings.acceptanceCriteriaFieldName];
            }
        },

        addAcceptanceCriteria(issue, description) {
            let settings = BreakdownEnvironment.getSettings();
