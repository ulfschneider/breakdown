        ...
        deleteIssue(deleteJiraObject, upload, credentials) {
            ...
            return BreakdownRequest.request(options)
                ...
                .catch(error => {
                    ...
                    console.warn('Issue could not be deleted in JIRA, issuetype=[' + BreakdownUtil.getIssueType(issue) + ']' + (rootCause ? ' due to ' + rootCause : ''));
                });
        },
        ...
        updateIssue(updateJiraObject, upload, credentials) {
            ...
            return BreakdownRequest.request(options)
                ...
                .catch(error => {
                    ...
                    console.warn('Issue could not be updated in JIRA, key=[' + BreakdownUtil.getKey(issue) + ']' + (rootCause ? ' due to ' + rootCause : ''));
                });
        ...
        createIssue(uploadJiraObject, upload, credentials) {
            ...
            return BreakdownRequest.request(options)
                ...
                .catch(error => {
                    ...
                    console.warn('Issue could not be created in JIRA, issuetype=[' + BreakdownUtil.getIssueType(issue) + '] summary=[' + BreakdownUtil.getSummary(issue) + ']' + (rootCause ? ' due to ' + rootCause : ''));
                });
        },
