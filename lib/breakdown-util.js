...
export default BreakdownUtil = (function() {
    ...
    return {
        ...
        isNewStatus(status) {
            return this.getStatusCategory(status) == 'new';
        },

        isIndeterminateStatus(status) {
            return this.getStatusCategory(status) == 'indeterminate';
        },

        isDoneStatus(status) {
            return this.getStatusCategory(status) == 'done';
        },
        ...
        getStoryPoints(issue) {
            let settings = BreakdownEnvironment.getSettings();
            let value = settings.storyPointsFieldName && issue.fields[settings.storyPointsFieldName] ? issue.fields[settings.storyPointsFieldName] : '';
