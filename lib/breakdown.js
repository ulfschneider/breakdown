...
export default {
    ...
    activate() {
        ...
        this.statisticsPanel = atom.workspace.addBottomPanel({
            ...
            visible: BreakdownEnvironment.isBreakdownGrammar(),
            priority: 1000
        });
    ...
    maintainStatisticsPanelVisibility(editor) {
    ...
    initiatePull() {
        if (BreakdownEnvironment.isBreakdownGrammar()) {
            if (BreakdownEnvironment.isLocked() && BreakdownEnvironment.isHandlingDifferentEditors()) {
