            ...
            for (let issue of download.issues) {
                ...
                if (BreakdownUtils.isSameIssueType(download.settings.epicType, issueType)) {
                    ...
                    if (this.isResolved(issue)) {
                        download.settings.epicResolvedStates.add(this.getStatus(issue));
                    }
                    ...
                    if (this.isResolved(issue)) {
                        download.settings.storyResolvedStates.add(this.getStatus(issue));
                    }
                    ...
                    if (this.isResolved(issue)) {
                        download.settings.subTaskResolvedStates.add(this.getStatus(issue));
                    }
                }
            }
        },
