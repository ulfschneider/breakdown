...
export default BreakdownPush = (function() {
    ...
    return {
        ...
        maintainEpicLink(storyIssue, parentIssue, settings) {
            ...
            if (parentKey &&
                parentKey != BreakdownUtil.NO_PARENT_IN_SELECTION_KEY &&
                parentKey != BreakdownUtil.EMPTY_PARENT_KEY) {
                BreakdownUtil.setEpicLink(storyIssue, parentKey, settings);
            } else if (parentKey == BreakdownUtil.EMPTY_PARENT_KEY) {
                BreakdownUtil.setEpicLink(storyIssue, '', settings);
            }
        },
        ...
        maintainParentLink(subTaskIssue, parentIssue, settings) {
            ...
            if (parentKey &&
                parentKey != BreakdownUtil.NO_PARENT_IN_SELECTION_KEY &&
                parentKey != BreakdownUtil.EMPTY_PARENT_KEY) {
                BreakdownUtil.setParentKey(subTaskIssue, parentKey);
            } else if (parentKey == BreakdownUitl.EMPTY_PARENT_KEY) {
                BreakdownUtil.setParentKey(subTaskIssue, '');
            }
        },
