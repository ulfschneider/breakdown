...
export default BreakdownPull = (function() {
    ...
    return {
        ...
        extractCustomFieldNames(issuetypes, settings) {
            ...
            if (!settings.epicLinkFieldName || !settings.epicNameFieldName || !settings.storyPointsFieldName) {
                throw new Error('Custom fieldnames for Epic Name, Epic Link or Story Points could not be resolved');
            }
        },
        ...
        pullCustomFieldNames(settings, credentials) {
            ...
            then((body) => {
                ...
                this.extractCustomFieldNames(body.projects[0].issuetypes, settings);
        ...
        pullFromJIRA(download, credentials) {
            ...
            return this.pullCustomFieldNames(download.settings, credentials)
                ...
                .catch((error) => {
                    ...
                    atom.notifications.addWarning('Failure when pulling JIRA data' + (rootCause ? '\n\n' + rootCause : ''), {
                        dismissable: true
                    });
                });
        },
