...
export default {
    //user available editor config
    config: {
        jiraUrl: {
            title: 'JIRA URL',
            description: 'This URL will be used in case you don´t provide a URL in the config section of your .bknd file',
            type: 'string',
            default: ''
        },
        foldAfterPull: {
            title: 'Fold all editor lines after a pull',
            type: 'boolean',
            default: true,
        }
    },
