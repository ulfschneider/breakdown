        ...
        makeUploadDataStructure(upload, download) {
            ...
            tokens.forEach((token, rowCount) => {
                ...
                if (BreakdownParse.rowHasScope(token, 'issue.no-parent-in-selection.jira')) {
                    parentEpicIssue = null;
                    parentStoryIssue = null;
                    issue = null;
                    let noParent = {};
                    BreakdownUtil.setKey(noParent, BreakdownUtil.NO_PARENT_IN_SELECTION_KEY);
                    BreakdownRank.addEpic(upload, noParent);
                } else if (BreakdownParse.rowHasScope(token, 'issue.empty-parent.jira')) {
                    parentEpicIssue = null;
                    parentStoryIssue = null;
                    issue = null;
                    let epmptyParent = {};
                    BreakdownUtil.setKey(emptyParent, BreakdownUtil.EMPTY_PARENT_KEY);
                    BreakdownRank.addEpic(upload, emptyParent);
