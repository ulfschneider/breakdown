...
export default BreakdownPush = (function() {
    ...
    return {
        ...
        updateIssue(updateJiraObject, settings, credentials) {
            console.log('maintain parent for ' + updateJiraObject.issue.key);
            console.log(JSON.stringify(updateJiraObject.parentIssue));
            this.maintainParent(updateJiraObject, settings);
            console.log(JSON.stringify(updateJiraObject.issue));
